...
var config = {
    ...
    module: {
        ...
        loaders: [{
            ...
            test: /\.woff(\?v=\d+\.\d+\.\d+)?$/,
            loader: "url?mimetype=application/font-woff&name=./assets/javascripts/build/[hash].[ext]"
        }, {
            test: /\.woff2(\?v=\d+\.\d+\.\d+)?$/,
            loader: "url?mimetype=application/font-woff&name=./assets/javascripts/build/[hash].[ext]"
        }, {
            test: /\.ttf(\?v=\d+\.\d+\.\d+)?$/,
            loader: "url?mimetype=application/octet-stream&name=./assets/javascripts/build/[hash].[ext]"
        }, {
            test: /\.eot(\?v=\d+\.\d+\.\d+)?$/,
            loader: "file-loader"
        }]
